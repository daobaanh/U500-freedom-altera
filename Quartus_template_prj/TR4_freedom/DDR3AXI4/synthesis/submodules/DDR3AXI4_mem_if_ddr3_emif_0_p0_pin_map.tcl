...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_get_input_clk_id { pll_output_node_id } {
	if {[DDR3AXI4_mem_if_ddr3_emif_0_p0_is_node_type_pll_clk $pll_output_node_id]} {
		...
		DDR3AXI4_mem_if_ddr3_emif_0_p0_traverse_fanin_up_to_depth $pll_output_node_id DDR3AXI4_mem_if_ddr3_emif_0_p0_is_node_type_pll_inclk clock results_array 1
		if {[array size results_array] == 1} {
			...
			DDR3AXI4_mem_if_ddr3_emif_0_p0_traverse_fanin_up_to_depth $pll_inclk_id DDR3AXI4_mem_if_ddr3_emif_0_p0_is_node_type_pin clock results_array 3
			if {[array size results_array] == 1} {
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_get_output_clock_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 13} } {
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_get_output_clock_clkbuf_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 13} } {
	upvar 1 $msg_list_name msg_list
	set output_clock_id -1
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_get_dqs_phase_setting { dqs_pins } {
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_get_dqs_phase { dqs_pins } {
	...
	set dqs_phase_setting [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_dqs_phase_setting $dqs_pins ]

	if { $dqs_phase_setting != $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_dqs_delay_chain_length } {
		...
		post_message -type critical_warning "   Parameter value: $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_dqs_delay_chain_length"
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_get_ddr_pins { instname allpins } {
	...
	# DQ PLL
	set pll_write_clock_id [DDR3AXI4_mem_if_ddr3_emif_0_p0_get_output_clock_id [ join [ join $pins(q_groups) ]] "Write CK" msg_list]
	...
	set pll_afi_half_clock_id [DDR3AXI4_mem_if_ddr3_emif_0_p0_get_output_clock_id $pins(afi_half_ck_pins) "AFI HALF CK" msg_list]
	if {$pll_afi_half_clock_id == -1} {
		foreach {msg_type msg} $msg_list {
			post_message -type $msg_type "DDR3AXI4_mem_if_ddr3_emif_0_p0_pin_map.tcl: $msg"
		}
		post_message -type critical_warning "DDR3AXI4_mem_if_ddr3_emif_0_p0_pin_map.tcl: Failed to find PLL clock for pins [join $pins(afi_half_ck_pins)]"
	} else {
		set pll_afi_half_clock [DDR3AXI4_mem_if_ddr3_emif_0_p0_get_pll_clock_name $pll_afi_half_clock_id]
	}
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_dump_static_pin_map { ddr_db_par filename } {
	...
	foreach instname $instnames {
		...
		DDR3AXI4_mem_if_ddr3_emif_0_p0_static_map_expand_string $FH pins pll_afi_half_clock
		...
		DDR3AXI4_mem_if_ddr3_emif_0_p0_static_map_expand_list $FH pins leveling_pins
		...
		DDR3AXI4_mem_if_ddr3_emif_0_p0_static_map_expand_string $FH pins valid_fifo_wrdata_reg 
		DDR3AXI4_mem_if_ddr3_emif_0_p0_static_map_expand_string $FH pins valid_fifo_rddata_reg
