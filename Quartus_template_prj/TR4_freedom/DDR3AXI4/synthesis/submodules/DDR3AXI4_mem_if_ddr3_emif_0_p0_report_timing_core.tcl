...
#############################################################
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_perform_flexible_write_launch_timing_analysis {opcs opcname inst family DQS_min_max interface_type max_package_skew dll_length period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
	...
	set ref_pll_min_of_max [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection $ref_pll_paths_max "arrival_time"]
	set ref_pll_min_of_min [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection $ref_pll_paths_min "arrival_time"]	
	...
	if {($result == 1)} {
		...
		foreach dqpins $pins(q_groups) {
			...
			set DQSperiphery_delay [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection $DQSperiphery_min "arrival_time"]
			set aiot_delay [DDR3AXI4_mem_if_ddr3_emif_0_p0_round_3dp [expr [DDR3AXI4_mem_if_ddr3_emif_0_p0_get_min_aiot_delay $dqspin] * 1e9]]
			...
			foreach dqpin $dqdmpins {
				...
				set DQperiphery_delay [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection $DQperiphery_min "arrival_time"]
				set aiot_delay [DDR3AXI4_mem_if_ddr3_emif_0_p0_round_3dp [expr [DDR3AXI4_mem_if_ddr3_emif_0_p0_get_min_aiot_delay $dqpin] * 1e9]]
...
#############################################################
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_perform_flexible_read_capture_timing_analysis {opcs opcname inst family DQS_min_max io_std interface_type max_package_skew dqs_phase period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name} {
	...
	if {($result == 1)} {
		...
		foreach qpins $pins(q_groups) {
			...
			set DQSperiphery_delay [DDR3AXI4_mem_if_ddr3_emif_0_p0_max_in_collection $DQSperiphery_min "arrival_time"]
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_perform_ac_analyses {opcs opcname inst DQS_min_max pin_array_name timing_parameters_array_name summary_name IP_name} {
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_perform_flexible_write_levelling_timing_analysis {opcs opcname instname family period dll_length interface_type tJITper tJITdty tDCD pll_steps pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set dqs_launch_time [DDR3AXI4_mem_if_ddr3_emif_0_p0_max_in_collection $data_hold "latch_time"]
	set clk_launch_time [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection $ac_setup "latch_time"]
	...
	set clk_min [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection [get_path -from $pins(pll_ck_clock) -to $pins(ck_pins) -min_path] "arrival_time"]
	...
	set dqs_max [expr [DDR3AXI4_mem_if_ddr3_emif_0_p0_max_in_collection $dqs_path_part1 "arrival_time"] + [DDR3AXI4_mem_if_ddr3_emif_0_p0_max_in_collection $dqs_path_part2 "arrival_time"]]
	...
	# Get the min CLK delay
	set clk_max [DDR3AXI4_mem_if_ddr3_emif_0_p0_max_in_collection [get_path -from $pins(pll_ck_clock) -to $pins(ck_pins)] "arrival_time"]
	...
	set dqs_min [expr [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection $dqs_path_part1 "arrival_time"] + [DDR3AXI4_mem_if_ddr3_emif_0_p0_min_in_collection $dqs_path_part2 "arrival_time"]]
...
proc DDR3AXI4_mem_if_ddr3_emif_0_p0_perform_resync_timing_analysis {opcs opcname inst fbasename family DQS_min_max io_std interface_type period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name SSN_name} {
