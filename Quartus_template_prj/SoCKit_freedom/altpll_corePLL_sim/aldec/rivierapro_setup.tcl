...
# ACDS 18.1 625 win32 2019.08.23.16:50:22
# ----------------------------------------
...
# ----------------------------------------
# If altpll_corePLL is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "altpll_corePLL"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altpll_corePLL.vo"
}
