...
foreach { inst } $instances {
	...
	# AFI clock
	set local_pll_afi_clk [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		-target $pll_afi_clock \
		-suffix "afi_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_AFI_CLK) \
		-divide_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_AFI_CLK) \
		-phase $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(PLL_AFI_CLK) ]
	
	# HR PHY clock
	set local_pll_afi_phy_clk [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
	...
	# DQ write clock
	set local_pll_dq_write_clk [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		-target $pll_dq_write_clock \
		-suffix "dq_write_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_WRITE_CLK) \
		-divide_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_WRITE_CLK) \
		-phase $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(PLL_WRITE_CLK) ]
	
	# DQS write clock
	set local_pll_write_clk [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		-target $pll_write_clock \
		-suffix "write_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_MEM_CLK) \
		-divide_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_MEM_CLK) \
		-phase $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(PLL_MEM_CLK) ]

	# A/C clock
	set local_pll_addr_cmd_clk [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		-target $pll_ac_clock \
		-suffix "addr_cmd_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_ADDR_CMD_CLK) \
		-divide_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_ADDR_CMD_CLK) \
		-phase $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(PLL_ADDR_CMD_CLK) ]

	# NIOS clock
	set local_pll_avl_clock [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		-target $pll_avl_clock \
		-suffix "avl_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_NIOS_CLK) \
		-divide_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_NIOS_CLK) \
		-phase $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(PLL_NIOS_CLK) ]

	set mem_factor [expr double($::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_MEM_CLK)) / $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_MEM_CLK)]
	set avl_factor [expr double($::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_NIOS_CLK)) / $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_NIOS_CLK)]
	set write_to_avl_clk_ratio [expr int($mem_factor / $avl_factor)]	
	

	# I/O scan chain clock
	set local_pll_config_clock [ DDR3AXI4_mem_if_ddr3_emif_0_p0_get_or_add_clock_vseries \
		-target $pll_config_clock \
		-suffix "config_clk" \
		-source $pll_ref_clock \
		-multiply_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_mult(PLL_CONFIG_CLK) \
		-divide_by $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_div(PLL_CONFIG_CLK) \
		-phase $::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(PLL_CONFIG_CLK) ]	



	# Pulse-generator used by DQS tracking
	set local_sampling_clock "${inst}|DDR3AXI4_mem_if_ddr3_emif_0_p0_sampling_clock"
	...
	foreach { ck_pin } $ck_pins { 
		set_output_delay -add_delay -clock [get_clocks $ck_pin] -max [DDR3AXI4_mem_if_ddr3_emif_0_p0_round_3dp [expr $t(CK) - $t(DQSS)*$t(CK) - $board(minCK_DQS_skew) ]] $dqs_pins
		set_output_delay -add_delay -clock [get_clocks $ck_pin] -min [DDR3AXI4_mem_if_ddr3_emif_0_p0_round_3dp [expr $t(DQSS)*$t(CK) - $board(maxCK_DQS_skew) ]] $dqs_pins
	...
	set ac_fr_phase_mod_360 [expr round(2*$::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(3)) % 360]
	set ck_fr_phase_mod_360 [expr round($::GLOBAL_DDR3AXI4_mem_if_ddr3_emif_0_p0_pll_phase(1)) % 360]
